...
Christiane Fellbaum (1998, ed.) WordNet: An Electronic Lexical Database. Cambridge, MA: MIT Press.'),
 (2,'Open English Wordnet','2024','3.1','https://github.com/globalwordnet/english-wordnet','Global WordNet Association','John P. McCrae, Alexandre Rademaker, Francis Bond, Ewa Rudnicka, and Christiane Fellbaum, English WordNet 2019 – An Open-Source WordNet for English, Proceedings of the 10th Global Wordnet Conference, pp. 245–252, Wroclaw, Poland. Global Wordnet Association, 2019'),
